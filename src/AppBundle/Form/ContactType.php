...
class ContactType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
         ...
         *      - type de champ : http://symfony.com/doc/current/reference/form/types.html
         *      - options du champ
         *              contrainte de validation : http://symfony.com/doc/current/reference/constraints.html
         */
        $builder
            ->add('firstname', TextType::class, [
                'constraints' => [
                    ...
                    new Length([
                        'min' => 2,
                        'minMessage' => 'Votre prenom doit comporter 2 caractères au minimum'
                    ])
